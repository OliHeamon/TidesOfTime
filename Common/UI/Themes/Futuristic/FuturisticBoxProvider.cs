...
{
    public class FuturisticBoxProvider : ThemeBoxProvider
    {
        public override string NameKey => "FuturisticBoxes";

        public override void DrawBox(SpriteBatch spriteBatch, Rectangle target, Color color)
        {
            Texture2D tex = ModContent.Request<Texture2D>("TidesOfTime/Assets/UI/Themes/Futuristic/Box").Value;
