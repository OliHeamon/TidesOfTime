...
namespace TidesOfTime.Common.UI
{
    public static class UIHelper
    {
        ...
        public static void OpenConfig(ModConfig config)
        {
            ...
            setMod.Invoke(ui, new object[] { ModContent.GetInstance<TidesOfTime>(), config });
        ...
        {
            ThemeSystem.SetBoxProvider<FuturisticBoxProvider>();
            ThemeSystem.SetIconProvider<FuturisticIconProvider>();

            ThemeSystem.currentColorProvider.buttonColor = TidesOfTime.FuturisticButtonColor;
            ThemeSystem.currentColorProvider.backgroundColor = TidesOfTime.FuturisticBackgroundColor;
        }
    }
}
