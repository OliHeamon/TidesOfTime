...
{
    public class BreakerDrone : WorkerDrone
    {
        public override float Laziness => 0.6f;
        ...
        {
            float sin = MathF.Sin(MathHelper.ToRadians(celebrationTimer * 4));
        ...
        public override void OnComplete()
        {
            ...
            RedFireworks(Projectile.Center - new Vector2(0, 128));
        }

        private void RedFireworks(Vector2 position)
        {
            for (int num764 = 0; num764 < 400; num764++)
            {
                ...
                int num767 = Dust.NewDust(new Vector2(position.X, position.Y), 6, 6, DustID.Firework_Red, 0f, 0f, 100);
